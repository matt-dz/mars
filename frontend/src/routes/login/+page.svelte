...
<div class="flex min-h-screen flex-col items-center justify-center px-4">
	<div class="mb-8 text-center">
		<div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-primary via-primary/80 to-destructive/60 shadow-lg shadow-primary/20">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-8 w-8 text-primary-foreground">
				<circle cx="12" cy="12" r="10" />
			</svg>
		</div>
		<h1 class="bg-gradient-to-r from-primary to-destructive/80 bg-clip-text text-4xl font-bold tracking-tight text-transparent">
			mars
		</h1>
