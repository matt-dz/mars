<script lang="ts">
	...
	let typeLabel = $derived(
		data.playlist.type === 'weekly' ? 'Weekly' : data.playlist.type === 'monthly' ? 'Monthly' : 'Custom'
	);
</script>
...
<div class="container mx-auto max-w-4xl px-4 py-8">
	...
	<!-- Hero Section -->
	<div class="mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-primary/20 via-accent/15 to-destructive/10 p-6 sm:p-8">
			...
			<div class="space-y-3">
				...
				<div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-muted-foreground">
					<span class="flex items-center gap-1.5">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-4 w-4">
							<path d="M6 3a3 3 0 00-3 3v2.25a3 3 0 003 3h2.25a3 3 0 003-3V6a3 3 0 00-3-3H6zM3.25 14.5a.75.75 0 000 1.5h13.5a.75.75 0 000-1.5H3.25zM3.25 17.5a.75.75 0 000 1.5h13.5a.75.75 0 000-1.5H3.25z" />
						</svg>
