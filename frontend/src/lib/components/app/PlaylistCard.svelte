...
<a href={resolve(`/playlist/${playlist.id}`)} class="group block">
	<Card.Root
		class="overflow-hidden transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/10"
	>
		...
		<Card.Header class="space-y-3 pt-5">
			<div class="flex items-start justify-between gap-3">
				<Card.Title class="line-clamp-2 leading-tight transition-colors group-hover:text-primary">
					{playlist.name}
				</Card.Title>
